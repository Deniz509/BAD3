...
namespace FoodAPI.Migrations
{
    ...
    [Migration("20240403124925_InitialCreate")]
            ...
            modelBuilder.Entity("FoodAPI.Data.Models.Batch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BakingGoodsId = 1,
                            Delay = 10f,
                            StartTime = new DateTime(2024, 4, 3, 14, 49, 24, 576, DateTimeKind.Local).AddTicks(6),
                            StopTime = new DateTime(2024, 4, 3, 15, 29, 24, 576, DateTimeKind.Local).AddTicks(9)
                        },
                        new
                        {
                            BatchId = 2,
                            BakingGoodsId = 2,
                            Delay = 0f,
                            StartTime = new DateTime(2024, 4, 3, 15, 39, 24, 576, DateTimeKind.Local).AddTicks(13),
                            StopTime = new DateTime(2024, 4, 3, 15, 59, 24, 576, DateTimeKind.Local).AddTicks(14)
                        },
                        new
                        {
                            BatchId = 3,
                            BakingGoodsId = 3,
                            Delay = 30f,
                            StartTime = new DateTime(2024, 4, 3, 15, 59, 24, 576, DateTimeKind.Local).AddTicks(16),
                            StopTime = new DateTime(2024, 4, 3, 16, 29, 24, 576, DateTimeKind.Local).AddTicks(18)
                        },
                        new
                        {
                            BatchId = 4,
                            BakingGoodsId = 4,
                            Delay = 40f,
                            StartTime = new DateTime(2024, 4, 3, 16, 59, 24, 576, DateTimeKind.Local).AddTicks(20),
                            StopTime = new DateTime(2024, 4, 3, 17, 19, 24, 576, DateTimeKind.Local).AddTicks(21)
                        });
                });
            ...
            modelBuilder.Entity("FoodAPI.Data.Models.Orders", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrdersId = 1,
                            DeliveryDate = new DateTime(2024, 4, 3, 14, 49, 24, 575, DateTimeKind.Local).AddTicks(9803),
                            DeliveryPlace = "Kvickly"
                        },
                        new
                        {
                            OrdersId = 2,
                            DeliveryDate = new DateTime(2024, 4, 4, 14, 49, 24, 575, DateTimeKind.Local).AddTicks(9863),
                            DeliveryPlace = "Rema1000"
                        },
                        new
                        {
                            OrdersId = 3,
                            DeliveryDate = new DateTime(2024, 4, 5, 14, 49, 24, 575, DateTimeKind.Local).AddTicks(9867),
                            DeliveryPlace = "Aldi"
                        },
                        new
                        {
                            OrdersId = 4,
                            DeliveryDate = new DateTime(2024, 4, 6, 14, 49, 24, 575, DateTimeKind.Local).AddTicks(9869),
                            DeliveryPlace = "Netto"
                        });
                });
