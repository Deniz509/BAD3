...
namespace istanbulbageri.Migrations
{
    ...
    [Migration("20240413112908_Migration2")]
            ...
            modelBuilder.Entity("FoodAPI.Data.Models.Batch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BakingGoodsID = 1,
                            Delay = 40f,
                            FinishTime = new DateTime(2024, 4, 13, 14, 9, 7, 536, DateTimeKind.Local).AddTicks(1288),
                            StartTime = new DateTime(2024, 4, 13, 13, 29, 7, 536, DateTimeKind.Local).AddTicks(1191)
                        },
                        new
                        {
                            BatchID = 2,
                            BakingGoodsID = 2,
                            Delay = 0f,
                            FinishTime = new DateTime(2024, 4, 13, 14, 39, 7, 536, DateTimeKind.Local).AddTicks(1297),
                            StartTime = new DateTime(2024, 4, 13, 14, 19, 7, 536, DateTimeKind.Local).AddTicks(1295)
                        },
                        new
                        {
                            BatchID = 3,
                            BakingGoodsID = 3,
                            Delay = 20f,
                            FinishTime = new DateTime(2024, 4, 13, 15, 9, 7, 536, DateTimeKind.Local).AddTicks(1302),
                            StartTime = new DateTime(2024, 4, 13, 14, 39, 7, 536, DateTimeKind.Local).AddTicks(1300)
                        },
                        new
                        {
                            BatchID = 4,
                            BakingGoodsID = 4,
                            Delay = 56f,
                            FinishTime = new DateTime(2024, 4, 13, 15, 59, 7, 536, DateTimeKind.Local).AddTicks(1497),
                            StartTime = new DateTime(2024, 4, 13, 15, 39, 7, 536, DateTimeKind.Local).AddTicks(1486)
                        });
                });
