...
namespace istanbulbageri.Migrations
{
    ...
    [Migration("20240413112842_Migration1")]
            ...
            modelBuilder.Entity("FoodAPI.Data.Models.Batch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BakingGoodsID = 1,
                            Delay = 40f,
                            FinishTime = new DateTime(2024, 4, 13, 14, 8, 41, 401, DateTimeKind.Local).AddTicks(4906),
                            StartTime = new DateTime(2024, 4, 13, 13, 28, 41, 401, DateTimeKind.Local).AddTicks(4837)
                        },
                        new
                        {
                            BatchID = 2,
                            BakingGoodsID = 2,
                            Delay = 0f,
                            FinishTime = new DateTime(2024, 4, 13, 14, 38, 41, 401, DateTimeKind.Local).AddTicks(4913),
                            StartTime = new DateTime(2024, 4, 13, 14, 18, 41, 401, DateTimeKind.Local).AddTicks(4912)
                        },
                        new
                        {
                            BatchID = 3,
                            BakingGoodsID = 3,
                            Delay = 20f,
                            FinishTime = new DateTime(2024, 4, 13, 15, 8, 41, 401, DateTimeKind.Local).AddTicks(4917),
                            StartTime = new DateTime(2024, 4, 13, 14, 38, 41, 401, DateTimeKind.Local).AddTicks(4916)
                        },
                        new
                        {
                            BatchID = 4,
                            BakingGoodsID = 4,
                            Delay = 56f,
                            FinishTime = new DateTime(2024, 4, 13, 15, 58, 41, 401, DateTimeKind.Local).AddTicks(4920),
                            StartTime = new DateTime(2024, 4, 13, 15, 38, 41, 401, DateTimeKind.Local).AddTicks(4919)
                        });
                });
