    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 40f, new DateTime(2024, 4, 20, 12, 30, 18, 707, DateTimeKind.Local).AddTicks(2903), new DateTime(2024, 4, 20, 11, 50, 18, 707, DateTimeKind.Local).AddTicks(2730) },
                    { 2, 2, 0f, new DateTime(2024, 4, 20, 13, 0, 18, 707, DateTimeKind.Local).AddTicks(2917), new DateTime(2024, 4, 20, 12, 40, 18, 707, DateTimeKind.Local).AddTicks(2915) },
                    { 3, 3, 20f, new DateTime(2024, 4, 20, 13, 30, 18, 707, DateTimeKind.Local).AddTicks(2923), new DateTime(2024, 4, 20, 13, 0, 18, 707, DateTimeKind.Local).AddTicks(2921) },
                    { 4, 4, 56f, new DateTime(2024, 4, 20, 14, 20, 18, 707, DateTimeKind.Local).AddTicks(2928), new DateTime(2024, 4, 20, 14, 0, 18, 707, DateTimeKind.Local).AddTicks(2926) }
                });
